...
<div class="container-fluid">
    <section class="section card mb-5">
        <h2 class="h1-responsive text-warning text-center ">Edit Presentation</h2>
        <div class="row">
            ...
            <div class="col-md-12 mb-md-0 mb-5">
                <form id="contact-form" class="container"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="md-form mb-0">
                                ...
                                <label for="email" class="">Link video</label>
                            </div>
                        </div>
                        <div class=" col-md-6">
                            <div class="md-form mb-0">
                    ...
                    <!-- Collapse buttons -->
                    <div>
                        <a class="btn btn-lg btn-warning" data-toggle="collapse" href="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
