        ...
        <section class="section card mb-5">
            ...
            <div class="row">
                ...
                <div class="col-md-12 mb-md-0 mb-5">
                    <form id="contact-form" class="container" action='{{ route('team.update',$team) }}' method="post" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <div class="md-form mb-0">
                                    <input type="text" value="{{$team->fonction}}" id="email" name="fonction"
                                        class="form-control">
